 ...
 */ 
    ...
    class Controller
    {
        ...
        private function render_reserved(){
            global $content_dir;
            include $content_dir."/reserved\/".$this->controller_key;
        }
    ...
    class DOM
    {
        ...
        function option_tags($index_option = null, $options = []){
            global $dom_globals;
            $nl  = $dom_globals["newline"];
            ...
            for ($i=0; $i < count($options); $i++) { 
                ...
                if($option["value"] == strtolower($index_option)){
                    $option_tags .= "<option value=\"$option_value\">$option_label</option>$nl";
                    unset($options[$i]);
                }
            }
    ...
    class Response{
        ...
        function print($method){
            $response_data = ["route"=>$this->route, "message"=>$this->messages];
